    ...
    <div class="w-full max-w-lg bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg">
      ...
      <form v-if="!promptAddAnother" @submit.prevent="onSubmit" class="space-y-5">
        ...
        <div>
          ...
          <select v-model="category" class="w-full px-4 py-2 border rounded-lg bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-400">
        ...
        <div>
          ...
          <input v-model="name" type="text" placeholder="Invoice title"
        ...
        <div>
          ...
          <input v-model="tax" type="number" step="0.01" placeholder="0.00"
            class="w-full px-4 py-2 border rounded-lg bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-400" />
        ...
        <div>
          ...
          <textarea v-model="description" rows="3" placeholder="Details about this invoice"
            class="w-full px-4 py-2 border rounded-lg bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-400 resize-none"></textarea>
      ...
      <div v-else class="space-y-4 text-center">
        ...
        <div class="flex justify-center space-x-4">
          <button @click="handleAddAnother" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">Yes</button>
          <button @click="handleDone" class="px-4 py-2 bg-gray-300 dark:bg-gray-700 text-gray-800 dark:text-gray-200 rounded-lg hover:bg-gray-400">No</button>
        </div>
      </div>
